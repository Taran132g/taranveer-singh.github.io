...
class PaperTrader:
    ...
    def monitor_alerts(self):
        ...
        # minimum to react quickly; consecutive empty polls double the wait
        # time up to a 2s ceiling to avoid hot loops when idle.
        min_sleep = 0.05   # fast reaction when alerts are flowing
