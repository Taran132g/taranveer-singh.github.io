...
# === MAIN UI ===
st.markdown("<h3 class='section-title'>Latest Alerts (One Per Symbol)</h3>", unsafe_allow_html=True)
...
with logbook_col:
    ...
    st.markdown("<h3 class='section-title'>Alert Log</h3>", unsafe_allow_html=True)
